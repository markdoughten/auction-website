...
class Config:
    ...
    SQLALCHEMY_CONN_URI = "mysql+pymysql://%s:%s@%s:%s" % (SQLALCHEMY_DATABASE_USER, quote(SQLALCHEMY_DATABASE_PASSWORD), SQLALCHEMY_DATABASE_HOST,SQLALCHEMY_DATABASE_PORT)
