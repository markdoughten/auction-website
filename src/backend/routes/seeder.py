...
from ..utils.seeders import seed_item_meta, seed_items, seed_users, seed_auctions, seed_bids, seed_qa, seed_alerts



@app.route('/seed/item_meta', methods=["POST"])
def api_seed_item_meta():
    seed_item_meta.seed_item_meta()
